...
class PyPixelShuffleLayer(caffe.Layer):
    ...
    def __pixShuf(self, I):
        ...
        I = I.reshape((n, int(oc), r, r, h, w))
        I = I.transpose(0,1,4,2,5,3)
        I = I.reshape((n, int(oc), h*r, w*r))
    ...
    def __pixUnShuf(self, I):
        ...
        h /= r
        w /= r        
        I = I.reshape((n, int(oc), int(h), r, int(w), r))
        I = I.transpose(0,1,3,5,2,4)
        I = I.reshape((n, int(c), int(h), int(w)))
    ...
    def reshape(self, bottom, top):
        ...
        top[0].reshape(self.n, int(self.out_channels), self.out_h, self.out_w)
